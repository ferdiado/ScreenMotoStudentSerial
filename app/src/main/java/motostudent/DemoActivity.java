...
//import com.aguilax.motostudent.USB.driver.*;
//import com.aguilax.motostudent.USB.util.*;
...
private void updateReceivedData(byte[] data) {
	String str9=String.valueOf(data) ; 
    final String message = "Read " + data.length + " bytes: \n"
            + HexDump.dumpHexString(data) +"Data9"+str9 +"\n\n";
    
    mDumpTextView.append(message);
    mScrollView.smoothScrollTo(0, mDumpTextView.getBottom());//mDumpTextView.getBottom()
}
